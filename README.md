...
Unlike other RL libraries that abstract away PyTorch, AgentOrchestration is built **with** PyTorch, not **on top of** it. We provide the building blocks you need while letting you maintain full control over your training loop, model architecture, and optimization strategy.
...
At the heart of AgentOrchestration is the **Rollout** - a conversation-like data structure that captures the full interaction between agents, tools, and environments.
...
*AgentOrchestration: RL for LLMs, the PyTorch way.*